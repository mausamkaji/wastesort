...
function AppContent() {
  ...
  return (
    <div className="relative min-h-screen bg-stone-50 bg-mesh flex flex-col selection:bg-emerald-100 selection:text-green-900 overflow-hidden">
      {/* Ambient decorative background blobs */}
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-32 -left-24 w-96 h-96 bg-emerald-300/20 rounded-full blur-3xl animate-blob" />
        <div className="absolute top-1/3 -right-24 w-96 h-96 bg-amber-300/15 rounded-full blur-3xl animate-blob animation-delay-2000" />
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-cyan-200/15 rounded-full blur-3xl animate-blob animation-delay-4000" />
      </div>
      ...
      {/* Global Footer */}
      <footer className="relative glass border-t-0 py-6 px-4 sm:px-6 mt-auto">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-500">
          <div className="flex items-center gap-2">
            <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-amber-600">WasteSort Quest</span>
